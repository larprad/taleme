  ...
  return (
    ...
    <div className="termsOfUse">
      ...
      <Container textAlign="justified">
        ...
        <p>En vigueur au 01/02/2021
          Les présentes conditions générales d'utilisation
          (dites « CGU ») ont pour objet l'encadrement
          juridique des modalités de mise à disposition du site
          et des services par _______________ et de définir les
          ...
          sur le site via le Formulaire d’inscription,
          chaque utilisateur accepte expressément les
          présentes CGU en cochant la case précédant le
          texte suivant : « Je reconnais avoir lu et
          compris les CGU et je les accepte ».
          En cas de non-acceptation des CGU stipulées dans le
          présent contrat, l'Utilisateur se doit de renoncer
          à l'accès des services proposés par le site.
          TaleMe.com se réserve le droit de modifier unilatéralement
          et à tout moment le contenu des présentes CGU.
        </p>
        ...
        <p>L’édition et la direction de la publication du site
          TaleMe.com est assurée par Toto, domicilié 1 chemin
          des histoires.
          Numéro de téléphone est 0102030405
          Adresse e-mail toto@gmail.com.

          L'hébergeur du site TaleMe.com est la société _______________,
          dont le siège social est situé au _______________,
        ...
        <p>Le site TaleMe.com permet à l'Utilisateur un accès
          gratuit aux services suivants :
          Création et lecture d'histoires personnalisables
          ...
          (matériel informatique, logiciels, connexion
          Internet, etc.) sont à sa charge.

          L’Utilisateur non membre n'a pas accès aux services réservés.
          Pour cela, il doit s’inscrire en remplissant le formulaire.
          En acceptant de s’inscrire aux services réservés, l’Utilisateur
          membre s’engage à fournir des informations sincères et
          exactes concernant son état civil et ses coordonnées, notamment
          son adresse email.
          ...
          son espace personnel. Celle-ci sera effective dans un délai raisonnable.
          ...
          la responsabilité de TaleMe.com. Dans ces cas, l’Utilisateur
          accepte ainsi ne pas tenir rigueur à l’éditeur de toute
        ...
        <p>Le site est exempté de déclaration à la Commission Nationale Informatique
        ...
        <p>Les marques, logos, signes ainsi que tous les contenus du site
          ...
          strictement privé, toute utilisation à des fins commerciales
          et publicitaires est strictement interdite.
        ...
        <p>Les sources des informations diffusées sur le site TaleMe.com
          sont réputées fiables mais le site ne garantit pas qu’il soit
          exempt de défauts, d’erreurs ou d’omissions.
          Les informations communiquées sont présentées à titre indicatif e
          général sans valeur contractuelle. Malgré des mises à jour
          régulières, le site TaleMe.com ne peut être tenu responsable de la
          ...
          Le site TaleMe.com ne peut être tenu pour responsable d’éventuels
        ...
        <p>Des liens hypertextes peuvent être présents sur le site.
          L’Utilisateur est informé qu’en cliquant sur ces liens,
          il sortira du site TaleMe.com. Ce dernier n’a pas de
          contrôle sur les pages web sur lesquelles aboutissent
          ces liens et ne saurait, en aucun cas, être responsable
          de leur contenu.
        </p>
        ...
        <p>L’Utilisateur est informé que lors de ses visites sur le site,
          un cookie peut s’installer automatiquement sur son logiciel
          de navigation.
          ...
          améliorer le site TaleMe.com.
          En naviguant sur le site, L’Utilisateur les accepte.

          L’Utilisateur doit toutefois donner son consentement quant
          à l’utilisation de certains cookies.
        ...
        <p>Le site permet aux membres de publier les contenus suivants :
          ...
          de la Netiquette (règles de bonne conduite de l’internet)
          et les règles de droit en vigueur.
          Le site peut exercer une modération sur les publications et
          se réserve le droit de refuser leur mise en ligne, sans avoir
          à s’en justifier auprès du membre.
          ...
          propriété intellectuelle. Le Membre cède notamment le
          droit d'utiliser sa publication sur internet et sur
          ...
          tiers lésé contre le site sera pris en charge par l'Utilisateur.
        ...
        <p>La législation française s'applique au présent contrat. En
          ...
          vous pouvez joindre l’éditeur aux coordonnées inscrites à l’ARTICLE 1.
        </p>

      </Container>
      <Button className="Cgu-button" onClick={() => history.push('/')}>
        Retour à l'accueil
      </Button>
    </div>
  );
